...
#if defined CONFIG_ESP32_S3_KORVO_V4_0_BOARD || CONFIG_ESP32_S3_CUBE_V2_0_BOARD
static const struct es7210_reg_config es7210_tdm_reg_common_cfg2[] =
{
    { 0x40, 0xC3 },
    { 0x41, 0x70 },
...
static int es7210_micboost1_setting_set(unsigned char gain)
{
    if(gain > 14 )
        gain = 14;
...
static int es7210_micboost2_setting_set(unsigned char gain)
{
    if(gain > 14 )
        gain = 14;
...
static int es7210_micboost3_setting_set(unsigned char gain)
{
    if(gain > 14 )
        gain = 14;
...
static int es7210_micboost4_setting_set(unsigned char gain)
{
    if(gain > 14 )
        gain = 14;
