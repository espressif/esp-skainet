...
- Build
  ...
  - python tools/ci/build_apps.py examples/cn_speech_commands_recognition -t esp32s3
- Test
  - pip install -r tools/ci/requirements.txt
  - pytest examples/cn_speech_commands_recognition --target esp32s3
'''
...
def test_cn_speech_commands_example(dut: Dut, assert_no_crash) -> None:
